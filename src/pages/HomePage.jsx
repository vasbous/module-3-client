  ...
  return (
    <div className="container-homePage">
      ...
      <section className="first-section">
        ...
        <div className="img-home-page"><img src={question} alt="Human Question" /></div>
        <h2 className="title-home">Change your life
        step by step</h2>
        <div class="second-wave">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <h2 className="title-home">Whatever your needs</h2>
        <div className="img-home-page"><img src={road} alt="which direction you want to take" /></div>
        <div className="title-button-home">
        <h2 className="title-home">Choose the change you want to make in your life</h2>
        <div className="text-center"><Link className="btn">Change your life</Link></div>
      ...
      <section className="third-section">
        <h2 className="title-home">We create an action plan to help you reach your goal</h2>
        <div className="img-home-page"><img src={plan} alt="plan and task" /></div>
        <div class="fourth-wave">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1440 320"
      ...
      <section className="fourth-section">
        <div className="img-home-page"><img src={task} alt="create task" /></div>
        <div className="title-button-home">
        <h2 className="title-home">Simple, self-paced tasks</h2>
        <div className="text-center"><Link className="btn">Create your task</Link></div>
      ...
      <h2 className="title-home">Questions? Tasks you don't want to or can't do? </h2>
        <div className="img-home-page"><img src={non} alt="avatar" /></div>
        <div class="six-wave">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <section className="six-section">
        <div className="img-home-page"><img src={chat} alt="little robot" /></div>
        <div className="title-button-home">
        <h2 className="title-home">Our chat, with its powerful ia,will answer all your questions.</h2>
        <div className="text-center"><Link className="btn">Open Chat</Link></div>
        
        </div>
        <div class="seven-wave">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1440 320"
